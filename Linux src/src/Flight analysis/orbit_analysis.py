...
def main():
    passfail_data_path = r'Shared\Data\Flight Metadata\sortedpassfail_list.pkl'
    ...
    orbit_analyzer = OrbitAnalyzer(passfail_data, flight_data, orbit_criteria)

    # Export the updated passfail_data to Excel
    export_to_excel(passfail_data, r'Shared\Data\Flight Metadata\orbit_passfail_list.xlsx')
    save_data_to_file(passfail_data, r'Shared\Data\Flight Metadata\orbit_passfail_list.pkl')
    #print("Updated pass/fail list exported to 'Shared\\Data\\Flight Metadata\\orbit_passfail_list.xlsx'.")
