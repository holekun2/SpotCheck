...
class CompoundCheckAnalyzer:
    ...
    def save_results(self, output_pkl_path: str, output_excel_path: str):
        with open(output_pkl_path, 'wb') as f:
            pickle.dump(self.passfail_data, f)
    ...
    def run_analysis(self, passfail_data_path: str, flight_data_path: str, 
        ...
        ##print("Analyzing compound check...")
        self.analyze_compound_check()
        
        ##print("Saving results...")
        self.save_results(output_pkl_path, output_excel_path)
        
        ##print("Compound check analysis complete.")

# def main():
#     analyzer = CompoundCheckAnalyzer()
#     analyzer.run_analysis(
#         passfail_data_path=r'Shared\Data\Flight Metadata\topdown_passfail_list.pkl',
#         flight_data_path=r'Shared\Data\Flight Metadata\sortedflightdata.pkl',
#         output_pkl_path=r'Shared\Data\Flight Metadata\compound_passfail_list.pkl',
#         output_excel_path=r'Shared\Data\Flight Metadata\compound_passfail_list.xlsx'
#     )
