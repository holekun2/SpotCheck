...
def main():
    passfail_data_path = r'Shared\Data\Flight Metadata\ascent_descent_passfail_list.pkl'
    ...
    analyzer = TowerFlightType1Analyzer(passfail_data, flight_data)
    analyzer.analyze()

    # Export the updated passfail_data to Excel
    export_to_excel(passfail_data, r'Shared\Data\Flight Metadata\tf_passfail_list.xlsx')
    save_data_to_file(passfail_data, r'Shared\Data\Flight Metadata\tf_passfail_list.pkl')
    #print("Updated pass/fail list exported to 'Shared\\Data\\Flight Metadata\\tf_passfail_list.xlsx'.")
